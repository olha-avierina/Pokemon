...
class Combat:
    ...
    def attack(self, pokemon_attacker, pokemon_defender):
        if random.randint(0, 1) == 1:
            attack_power = pokemon_attacker.attack_power * \
                self.get_attack_multiplier(pokemon_attacker, pokemon_defender)
            ...
            print(pokemon_attacker.get_name(), "attacks",
                  pokemon_defender.get_name(), "for", damage, "damage")
